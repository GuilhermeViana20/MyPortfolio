...
import nuxt_plugin_plugin_5b9d4e1e from 'nuxt_plugin_plugin_5b9d4e1e' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_6dd4f8c3 from 'nuxt_plugin_bootstrapvue_6dd4f8c3' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Virtuf","titleTemplate":"%s || Virtuf","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_5b9d4e1e === 'function') {
    await nuxt_plugin_plugin_5b9d4e1e(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_6dd4f8c3 === 'function') {
    await nuxt_plugin_bootstrapvue_6dd4f8c3(app.context, inject)
  }
